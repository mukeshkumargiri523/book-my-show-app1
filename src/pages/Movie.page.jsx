  ...
  return (
    <>
      ...
      <div className="my-12 container px-4 lg-ml-20 lg:w-2/1">
        ...
        <div className="my-8">
          <h2 className="text-gray-700 font-bold text-2xl mb-3">
            Applicable Offers
          </h2>
          <div className="flex flex-col gap-3 lg:flex-row ">
            <div className="flex items-start gap-2 bg-green-100 p-3 border-green-400 border-dashed border-2 rounded-md">
            ...
            <div className="flex items-start gap-2 bg-yellow-100 p-3 border-yellow-400 border-dashed border-2 rounded-md">
              ...
              <div className="flex flex-col items-start">
                <h3 className="text-gray-600 text-xl font-bold">Film Pass</h3>
                <p className="text-gray-500">
                  Get 75% off up to INR 200 on all RuPay Card* on BookMyShow
                  Stream
                </p>
